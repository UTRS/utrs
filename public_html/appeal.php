...
if (($appeal->getStatus() != Appeal::$STATUS_INVALID || $appeal->getStatus() != Appeal::$STATUS_UNVERIFIED) || (verifyAccess($GLOBALS['DEVELOPER'])&&($appeal->getStatus() == Appeal::$STATUS_INVALID || $appeal->getStatus() == Appeal::$STATUS_UNVERIFIED))) {
?>
