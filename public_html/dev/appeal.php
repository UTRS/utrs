...
<h3><a href="javascript:void()" onClick="showContextWindow('<?php echo mysql_real_escape_string($log->getLargeHTML()); ?>')">Logs for this request</a> (<a href="comment.php?id=<?php echo $_GET['id']; ?>">new comment</a>)</h3>
<div class="comments">
