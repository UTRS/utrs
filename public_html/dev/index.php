...
if(isset($_POST["submit"])){
	...
	try{
		...
		Log::ircNotification("\x033,0New appeal has been created for \x032,0" . $appeal->getCommonName() . " \x033,0(\x032,0 " . $appeal->getID() . " \x033,0) URL: " . getRootURL() . "appeal.php?id=" . $appeal->getID());
	}
