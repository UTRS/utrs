...
class Wiki {
	 ...
	 * @return void|bool
	 */
	public function purge( $titles = null, $pageids = null, $revids = null, $force = false, $redirects = false, $converttitles = false, $generator = null ) {
		...
		if( $converttitles ) $apiArr['converttitles'] = 'yes';
		
		$genparams = array( 'allcategories', 'allimages', 'alllinks', 'allpages', 'alltransclusions', 'backlinks', 'categories',
	...
	public function get_tokens( $force = false ) {
		...
		$tokens[] = $this->apiQuery( array(
			...
			'name' => 'wbfoiwerbfpijwenfpijeqnrfijnqwefijneofnweijnfjwenoifn'
		), true);	
		...
		$this->tokens['wpCreateaccount'] = $tokens[0]['createaccount']['token'];
