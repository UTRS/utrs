...
//Account name
echo '<div id="accountNameDiv" hidden><label id="wikiAccountNameLabel" for="wikiAccountName" class="required">What is the name of your account?</label> <input id="wikiAccountName" type="text" name="appeal_wikiAccountName" value="' . posted('appeal_wikiAccountName') . '"><br /><br /></div>';//Hidden text field, to be flipped by js
